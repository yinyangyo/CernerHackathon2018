...
class SignUpForm extends Component {
  ...
  onSubmit = (event) => {
    ...
    auth.doCreateUserWithEmailAndPassword(email, passwordOne)
      ...
      let myRegistrationJsonToBackEnd =this.state;
      console.log("myRegistrationJsonToBackEnd:", myRegistrationJsonToBackEnd);

    event.preventDefault();
  }

  fieldValue(type, event) {
    ...
    if (type == 'fullName') {
      ...
      this.setState({myHeight:event.target.value});
    }else if (type=='weight'){
      this.setState({myWeight:event.target.value});
    }else if (type=='idealWeight'){
      this.setState({myIdealWeight:event.target.value});
    } else if (type=='gender'){
      this.setState({myGender:event.target.value});
    } else if (type=='activityLevel'){
      this.setState({myActivityLevel:event.target.value});
    } else if (type=='foodPreference'){
      this.setState({myFoodPreference:event.target.value});
    }
    ...
    return (
      ...
      <div className="container__child signup__thumbnail">
        <div className="thumbnail__logo">
          ...
          <h1 className="logo__text">DietChart</h1>
        </div>
        <div className="thumbnail__content text-center">
          <h1 className="heading--primary">Welcome to DietChart.</h1>
      ...
      <input
          ...
          onKeyUp={this.fieldValue.bind(this, 'fullName')}
        />
      </div>
      <div className="form-group">
      ...
      <input
          ...
          className="form-control"
          onKeyUp={this.fieldValue.bind(this, 'email')}
        />
        </div>
        <div className="form-group">
        ...
        <input
          ...
          className="form-control"
          onKeyUp={this.fieldValue.bind(this, 'password')}
        />
          </div>
        ...
        <input required
          ...
          className="form-control"
          onKeyUp={this.fieldValue.bind(this, 'height')}
        />
        </div>
        <div className="form-group">
        ...
        <input required
          ...
          className="form-control"
          onKeyUp={this.fieldValue.bind(this, 'weight')}
        />
        </div>
        <div className="form-group">
        ...
        <input required
          type="number"
          placeholder="Ideal Weight in KGs"
          className="form-control"
          onKeyUp={this.fieldValue.bind(this, 'idealWeight')}
        />
        </div>
        <div className="form-group">
        <label for="Gender">Gender</label>
        <select required onChange={this.fieldValue.bind(this, 'gender')}>
        ...
        <select required onChange={this.fieldValue.bind(this, 'activityLevel')}>
        <option value="null">Please Select</option>
        <option value="0">Sadentary</option>
        ...
        <select required onChange={this.fieldValue.bind(this, 'foodPreference')}>
        <option value="null">Please Select</option>
        ...
        <ul className="list-inline">
          <li>
            <button disabled={isInvalid} className="btn btn--form" type="submit"> Register </button>
          </li>
          <li>
